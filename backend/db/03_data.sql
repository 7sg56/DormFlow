...
--   feepayment     — hostel_id column removed
--   complaint      — hostel_id column removed
--   accesslog      — hostel_id column removed
--   visitor_log    — hostel_id column removed
...
-- ============================================================
-- TABLE 2: student  (hostel_id removed)
-- ============================================================
INSERT INTO student (student_id, reg_no, first_name, last_name, date_of_birth, gender,
    ...
    permanent_address, city, state, pincode, admission_date, status) VALUES
('s-0001-0000-0000-000000000001', 'REG2021001', 'Arjun',   'Mehta',        '2003-04-12', 'Male',   '9790100001', NULL,         'arjun.m@gmail.com',   'arjun@college.edu',   'Computer Science', 'B.Tech', 3, 5, 'O+',  '22 MG Road, Salem',            'Chennai',    'Tamil Nadu', '600001', '2021-07-01', 'Active'),
('s-0001-0000-0000-000000000002', 'REG2021002', 'Divya',   'Krishnamurthy','2003-08-25', 'Female', '9790100002', '9790100012', 'divya.k@gmail.com',   'divya@college.edu',   'Electronics',      'B.Tech', 3, 5, 'A+',  '5 Anna Nagar, Madurai',        'Chennai',    'Tamil Nadu', '600002', '2021-07-01', 'Active'),
('s-0001-0000-0000-000000000003', 'REG2022001', 'Rohan',   'Verma',        '2004-01-17', 'Male',   '9790100003', NULL,         'rohan.v@gmail.com',   'rohan@college.edu',   'Mechanical',       'B.Tech', 2, 3, 'B+',  '10 Gandhi St, Trichy',         'Coimbatore', 'Tamil Nadu', '641001', '2022-07-01', 'Active'),
('s-0001-0000-0000-000000000004', 'REG2022002', 'Sneha',   'Iyer',         '2004-06-05', 'Female', '9790100004', NULL,         'sneha.i@gmail.com',   'sneha@college.edu',   'Civil',            'B.Tech', 2, 3, 'AB+', '7 Nehru Nagar, Vellore',       'Chennai',    'Tamil Nadu', '600002', '2022-07-01', 'Active'),
('s-0001-0000-0000-000000000005', 'REG2021003', 'Karthik', 'Rajan',        '2003-11-20', 'Male',   '9790100005', '9790100015', 'karthik.r@gmail.com', 'karthik@college.edu', 'Computer Science', 'B.Tech', 3, 5, 'O-',  '3 Kamaraj Ave, Chennai',       'Chennai',    'Tamil Nadu', '600001', '2021-07-01', 'Active'),
('s-0001-0000-0000-000000000006', 'REG2020001', 'Meera',   'Subramanian',  '2002-03-09', 'Female', '9790100006', NULL,         'meera.s@gmail.com',   'meera@college.edu',   'Information Tech', 'B.Tech', 4, 7, 'A-',  '11 Periyar Salai, Salem',      'Chennai',    'Tamil Nadu', '600002', '2020-07-01', 'Active'),
('s-0001-0000-0000-000000000007', 'REG2023001', 'Vikram',  'Patel',        '2005-07-30', 'Male',   '9790100007', NULL,         'vikram.p@gmail.com',  'vikram@college.edu',  'Electrical',       'B.Tech', 1, 1, 'B-',  '20 Rajiv Nagar, Coimbatore',   'Coimbatore', 'Tamil Nadu', '641001', '2023-07-01', 'Active'),
('s-0001-0000-0000-000000000008', 'REG2023002', 'Lakshmi', 'Venkatesh',    '2005-02-14', 'Female', '9790100008', '9790100018', 'lakshmi.v@gmail.com', 'lakshmi@college.edu', 'Biotechnology',    'B.Tech', 1, 1, 'O+',  '9 Indira Nagar, Vellore',      'Chennai',    'Tamil Nadu', '600002', '2023-07-01', 'Active'),
('s-0001-0000-0000-000000000009', 'REG2021004', 'Suresh',  'Babu',         '2003-09-01', 'Male',   '9790100009', NULL,         'suresh.b@gmail.com',  'suresh@college.edu',  'Computer Science', 'M.Tech', 3, 5, 'A+',  '15 Cross St, Erode',           'Chennai',    'Tamil Nadu', '600001', '2021-07-01', 'Active'),
('s-0001-0000-0000-000000000010', 'REG2022003', 'Anjali',  'Sharma',       '2004-05-22', 'Female', '9790100010', NULL,         'anjali.s@gmail.com',  'anjali@college.edu',  'Chemistry',        'B.Sc',  2, 3, 'AB-', '6 Rose Garden, Madurai',       'Coimbatore', 'Tamil Nadu', '641001', '2022-07-01', 'Active');
...
-- ============================================================
-- TABLE 5: bed  (is_available removed)
-- ============================================================
...
-- ============================================================
-- TABLE 7: allocation  (hostel_id + room_id removed)
-- ============================================================
...
-- ============================================================
-- TABLE 8: feepayment  (hostel_id removed)
-- ============================================================
...
-- ============================================================
-- TABLE 14: accesslog  (hostel_id removed)
-- ============================================================
...
-- ============================================================
-- TABLE 17: complaint  (hostel_id removed)
-- ============================================================
...
-- ============================================================
-- TABLE 18: visitor_log  (hostel_id removed)
-- ============================================================
...
-- ============================================================
-- TABLE 29: emergency_request  (hostel_id removed)
-- ============================================================
