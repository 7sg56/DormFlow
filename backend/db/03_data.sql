...
-- hostel_warden
-- ============================================================
INSERT INTO hostel_warden (warden_id, hostel_id, warden_name, password, warden_phone, warden_email, assigned_date, is_active) VALUES
('hw-001', 'h-0001-0000-0000-000000000001', 'Mr. Ramesh Kumar',   'hw-001', '9841000001', 'ramesh@hostel.edu',  '2005-06-01', TRUE),
('hw-002', 'h-0001-0000-0000-000000000002', 'Mrs. Priya Nair',    'hw-002', '9841000002', 'priya@hostel.edu',   '2008-06-01', TRUE),
('hw-003', 'h-0001-0000-0000-000000000003', 'Dr. Anand Selvaraj', 'hw-003', '9841000003', 'anand@hostel.edu',   '2015-06-01', TRUE),
-- Former warden (inactive) for audit trail
('hw-004', 'h-0001-0000-0000-000000000001', 'Mr. Senthil Raj',    'hw-004', '9841000004', 'senthil@hostel.edu', '2000-06-01', FALSE);
...
-- ============================================================
INSERT INTO student (student_id, reg_no, password, first_name, last_name, date_of_birth, gender,
...
('s-0001-0000-0000-000000000001', 'REG2021001', 'REG2021001', 'Arjun',     'Mehta',        '2003-04-12', 'Male',   '9790100001', NULL,         'arjun.m@gmail.com',     'arjun@college.edu',     'Computer Science', 'B.Tech', 3, 5, 'O+',  '22 MG Road, Salem',              '636001', '2021-07-01', 'Active',    'Prakash Mehta',     '9840200001', 'Father', 'm-001'),
('s-0001-0000-0000-000000000005', 'REG2021003', 'REG2021003', 'Karthik',   'Rajan',        '2003-11-20', 'Male',   '9790100005', '9790100015', 'karthik.r@gmail.com',   'karthik@college.edu',   'Computer Science', 'B.Tech', 3, 5, 'O-',  '3 Kamaraj Ave, Chennai',         '600001', '2021-07-01', 'Active',    'Rajan K',           '9840200007', 'Father', 'm-001'),
('s-0001-0000-0000-000000000009', 'REG2021004', 'REG2021004', 'Suresh',    'Babu',         '2003-09-01', 'Male',   '9790100009', NULL,         'suresh.b@gmail.com',    'suresh@college.edu',    'Computer Science', 'M.Tech', 3, 5, 'A+',  '15 Cross St, Erode',             '638001', '2021-07-01', 'Active',    'Babu S',            '9840200011', 'Father', 'm-001'),
('s-0001-0000-0000-000000000003', 'REG2022001', 'REG2022001', 'Rohan',     'Verma',        '2004-01-17', 'Male',   '9790100003', NULL,         'rohan.v@gmail.com',     'rohan@college.edu',     'Mechanical',       'B.Tech', 2, 3, 'B+',  '10 Gandhi St, Trichy',           '620001', '2022-07-01', 'Active',    'Ramesh Verma',      '9840200004', 'Father', 'm-001'),
('s-0001-0000-0000-000000000007', 'REG2023001', 'REG2023001', 'Vikram',    'Patel',        '2005-07-30', 'Male',   '9790100007', NULL,         'vikram.p@gmail.com',    'vikram@college.edu',    'Electrical',       'B.Tech', 1, 1, 'B-',  '20 Rajiv Nagar, Coimbatore',    '641001', '2023-07-01', 'Active',    'Dinesh Patel',      '9840200009', 'Father', 'm-001'),
('s-0001-0000-0000-000000000011', 'REG2021005', 'REG2021005', 'Praveen',   'Natarajan',    '2003-06-15', 'Male',   '9790100011', NULL,         'praveen.n@gmail.com',   'praveen@college.edu',   'Civil',            'B.Tech', 3, 5, 'A+',  '45 Nehru Nagar, Madurai',        '625001', '2021-07-01', 'Active',    'Natarajan P',       '9840200013', 'Father', 'm-001'),
('s-0001-0000-0000-000000000012', 'REG2022004', 'REG2022004', 'Harish',    'Balaji',       '2004-03-22', 'Male',   '9790100012', '9790100022', 'harish.b@gmail.com',    'harish@college.edu',    'Electronics',      'B.Tech', 2, 3, 'O+',  '7 Sakthi Nagar, Salem',          '636001', '2022-07-01', 'Active',    'Balaji H',          '9840200014', 'Father', 'm-001'),
('s-0001-0000-0000-000000000013', 'REG2023003', 'REG2023003', 'Deepak',    'Sundaram',     '2005-09-10', 'Male',   '9790100013', NULL,         'deepak.s@gmail.com',    'deepak@college.edu',    'Computer Science', 'B.Tech', 1, 1, 'B+',  '18 Periyar St, Chennai',         '600032', '2023-07-01', 'Active',    'Sundaram D',        '9840200015', 'Father', NULL),
('s-0001-0000-0000-000000000014', 'REG2020002', 'REG2020002', 'Arun',      'Krishnaswamy', '2002-12-05', 'Male',   '9790100014', NULL,         'arun.k@gmail.com',      'arun@college.edu',      'Information Tech', 'B.Tech', 4, 7, 'AB+', '32 Gandhi Salai, Vellore',        '632001', '2020-07-01', 'Active',    'Krishnaswamy A',    '9840200016', 'Father', 'm-001'),
('s-0001-0000-0000-000000000015', 'REG2022005', 'REG2022005', 'Senthil',   'Murugesan',    '2004-07-18', 'Male',   '9790100015', '9790100025', 'senthil.m@gmail.com',   'senthil@college.edu',   'Mechanical',       'B.Tech', 2, 3, 'O-',  '9 Anna Salai, Coimbatore',       '641001', '2022-07-01', 'Inactive',  'Murugesan S',       '9840200017', 'Father', NULL),
-- ── Girls Hostel students (Female) ──────────────────────────
('s-0001-0000-0000-000000000002', 'REG2021002', 'REG2021002', 'Divya',     'Krishnamurthy','2003-08-25', 'Female', '9790100002', '9790100012', 'divya.k@gmail.com',     'divya@college.edu',     'Electronics',      'B.Tech', 3, 5, 'A+',  '5 Anna Nagar, Madurai',          '625001', '2021-07-01', 'Active',    'Krishnamurthy T',   '9840200003', 'Father', 'm-002'),
('s-0001-0000-0000-000000000004', 'REG2022002', 'REG2022002', 'Sneha',     'Iyer',         '2004-06-05', 'Female', '9790100004', NULL,         'sneha.i@gmail.com',     'sneha@college.edu',     'Civil',            'B.Tech', 2, 3, 'AB+', '7 Nehru Nagar, Vellore',         '632001', '2022-07-01', 'Active',    'Suresh Iyer',       '9840200005', 'Father', 'm-002'),
('s-0001-0000-0000-000000000006', 'REG2020001', 'REG2020001', 'Meera',     'Subramanian',  '2002-03-09', 'Female', '9790100006', NULL,         'meera.s@gmail.com',     'meera@college.edu',     'Information Tech', 'B.Tech', 4, 7, 'A-',  '11 Periyar Salai, Salem',        '636001', '2020-07-01', 'Active',    'Subramanian P',     '9840200008', 'Father', NULL),
('s-0001-0000-0000-000000000008', 'REG2023002', 'REG2023002', 'Lakshmi',   'Venkatesh',    '2005-02-14', 'Female', '9790100008', '9790100018', 'lakshmi.v@gmail.com',   'lakshmi@college.edu',   'Biotechnology',    'B.Tech', 1, 1, 'O+',  '9 Indira Nagar, Vellore',        '632001', '2023-07-01', 'Active',    'Venkatesh R',       '9840200010', 'Father', NULL),
('s-0001-0000-0000-000000000016', 'REG2021006', 'REG2021006', 'Priya',     'Ramalingam',   '2003-05-14', 'Female', '9790100016', NULL,         'priya.r@gmail.com',     'priya@college.edu',     'Chemistry',        'B.Sc',  3, 5, 'O+',  '2 Kamarajar Nagar, Trichy',      '620001', '2021-07-01', 'Active',    'Ramalingam V',      '9840200018', 'Father', 'm-002'),
('s-0001-0000-0000-000000000017', 'REG2022006', 'REG2022006', 'Kavitha',   'Sundarajan',   '2004-10-30', 'Female', '9790100017', NULL,         'kavitha.s@gmail.com',   'kavitha@college.edu',   'Computer Science', 'B.Tech', 2, 3, 'B+',  '14 Greenfield Ave, Chennai',     '600040', '2022-07-01', 'Active',    'Sundarajan K',      '9840200019', 'Mother', 'm-002'),
('s-0001-0000-0000-000000000018', 'REG2023004', 'REG2023004', 'Nithya',    'Annamalai',    '2005-04-08', 'Female', '9790100018', '9790100028', 'nithya.a@gmail.com',    'nithya@college.edu',    'Electronics',      'B.Tech', 1, 1, 'AB-', '6 West Masi St, Madurai',        '625001', '2023-07-01', 'Active',    'Annamalai N',       '9840200020', 'Father', 'm-002'),
('s-0001-0000-0000-000000000019', 'REG2020003', 'REG2020003', 'Ramya',     'Gopalan',      '2002-07-22', 'Female', '9790100019', NULL,         'ramya.g@gmail.com',     'ramya@college.edu',     'Biotechnology',    'M.Sc',  4, 7, 'A+',  '30 Ramanathapuram, Coimbatore', '641001', '2020-07-01', 'Active',    'Gopalan R',         '9840200021', 'Father', NULL),
('s-0001-0000-0000-000000000020', 'REG2022007', 'REG2022007', 'Sangeetha', 'Pillai',       '2004-01-11', 'Female', '9790100020', NULL,         'sangeetha.p@gmail.com', 'sangeetha@college.edu', 'Mathematics',      'B.Sc',  2, 3, 'O-',  '17 Nehru Colony, Chennai',       '600032', '2022-07-01', 'Inactive',  'Pillai S',          '9840200022', 'Father', NULL),
-- ── Mixed Hostel students ────────────────────────────────────
('s-0001-0000-0000-000000000010', 'REG2022003', 'REG2022003', 'Anjali',    'Sharma',       '2004-05-22', 'Female', '9790100010', NULL,         'anjali.s@gmail.com',    'anjali@college.edu',    'Chemistry',        'B.Sc',  2, 3, 'AB-', '6 Rose Garden, Madurai',         '625001', '2022-07-01', 'Active',    'Rajesh Sharma',     '9840200012', 'Father', NULL),
('s-0001-0000-0000-000000000021', 'REG2021007', 'REG2021007', 'Vishnu',    'Prabhakaran',  '2003-02-28', 'Male',   '9790100021', NULL,         'vishnu.p@gmail.com',    'vishnu@college.edu',    'Electrical',       'B.Tech', 3, 5, 'B+',  '40 Rajaji St, Salem',            '636001', '2021-07-01', 'Active',    'Prabhakaran V',     '9840200023', 'Father', 'm-003'),
('s-0001-0000-0000-000000000022', 'REG2022008', 'REG2022008', 'Tamilselvi','Arumugam',     '2004-08-16', 'Female', '9790100022', '9790100032', 'tamils.a@gmail.com',    'tamilselvi@college.edu','Information Tech', 'B.Tech', 2, 3, 'O+',  '21 Palani Nagar, Erode',         '638001', '2022-07-01', 'Active',    'Arumugam T',        '9840200024', 'Father', 'm-004'),
('s-0001-0000-0000-000000000023', 'REG2023005', 'REG2023005', 'Siva',      'Shankar',      '2005-11-03', 'Male',   '9790100023', NULL,         'siva.s@gmail.com',      'siva@college.edu',      'Mechanical',       'B.Tech', 1, 1, 'A-',  '5 Raja Nagar, Trichy',           '620001', '2023-07-01', 'Active',    'Shankar S',         '9840200025', 'Father', 'm-003'),
('s-0001-0000-0000-000000000024', 'REG2020004', 'REG2020004', 'Deepika',   'Mohan',        '2002-06-19', 'Female', '9790100024', NULL,         'deepika.m@gmail.com',   'deepika@college.edu',   'Computer Science', 'M.Tech', 4, 7, 'B-',  '13 Avinashi Road, Coimbatore',  '641001', '2020-07-01', 'Active',    'Mohan D',           '9840200026', 'Father', 'm-004'),
('s-0001-0000-0000-000000000025', 'REG2021008', 'REG2021008', 'Balaji',    'Selvakumar',   '2003-03-07', 'Male',   '9790100025', '9790100035', 'balaji.sk@gmail.com',   'balaji@college.edu',    'Computer Science', 'B.Tech', 3, 5, 'O+',  '55 Bharathi Nagar, Vellore',     '632001', '2021-07-01', 'Active',    'Selvakumar B',      '9840200027', 'Father', 'm-003'),
('s-0001-0000-0000-000000000026', 'REG2022009', 'REG2022009', 'Geetha',    'Chandrasekaran','2004-09-25','Female', '9790100026', NULL,         'geetha.c@gmail.com',    'geetha@college.edu',    'Physics',          'B.Sc',  2, 3, 'A+',  '8 Srinivasa Nagar, Chennai',     '600040', '2022-07-01', 'Active',    'Chandrasekaran G',  '9840200028', 'Father', 'm-004'),
('s-0001-0000-0000-000000000027', 'REG2023006', 'REG2023006', 'Prashanth', 'Raj',          '2005-01-14', 'Male',   '9790100027', NULL,         'prashanth.r@gmail.com', 'prashanth@college.edu', 'Electrical',       'B.Tech', 1, 1, 'AB+', '27 Mahalingapuram, Chennai',     '600034', '2023-07-01', 'Active',    'Raj P',             '9840200029', 'Father', NULL),
('s-0001-0000-0000-000000000028', 'REG2020005', 'REG2020005', 'Saranya',   'Venkataramani','2002-10-31', 'Female', '9790100028', '9790100038', 'saranya.v@gmail.com',   'saranya@college.edu',   'Biotechnology',    'M.Sc',  4, 7, 'O-',  '3 Mettur Road, Salem',           '636001', '2020-07-01', 'Active',    'Venkataramani S',   '9840200030', 'Father', 'm-004'),
('s-0001-0000-0000-000000000029', 'REG2022010', 'REG2022010', 'Murugan',   'Palaniswamy',  '2004-04-02', 'Male',   '9790100029', NULL,         'murugan.p@gmail.com',   'muruganp@college.edu',  'Civil',            'B.Tech', 2, 3, 'B+',  '16 Sathy Road, Coimbatore',     '641001', '2022-07-01', 'Active',    'Palaniswamy M',     '9840200031', 'Father', 'm-003'),
('s-0001-0000-0000-000000000030', 'REG2023007', 'REG2023007', 'Keerthana', 'Ravi',         '2005-06-20', 'Female', '9790100030', NULL,         'keerthana.r@gmail.com', 'keerthana@college.edu', 'Mathematics',      'B.Sc',  1, 1, 'A-',  '11 Usman Road, Chennai',         '600017', '2023-07-01', 'Active',    'Ravi K',            '9840200032', 'Mother', NULL);
...
-- ============================================================
INSERT INTO technician (technician_id, name, password, phone, email, availability, joining_date, employment_type, salary, hostel_id) VALUES
('t-001', 'Murugan A',     't-001', '9841300001', 'murugan@hostel.edu',  'Mon-Sat 8AM-6PM', '2018-06-01', 'Full-time', 22000.00, 'h-0001-0000-0000-000000000001'),
('t-002', 'Selvam R',      't-002', '9841300002', 'selvam@hostel.edu',   'Mon-Fri 9AM-5PM', '2019-03-15', 'Full-time', 20000.00, 'h-0001-0000-0000-000000000002'),
('t-003', 'Balamurugan K', 't-003', '9841300003', 'bala@hostel.edu',     'On Call',         '2020-01-10', 'Part-time', 15000.00, 'h-0001-0000-0000-000000000003'),
('t-004', 'Shanmugam T',   't-004', '9841300004', NULL,                  'Mon-Sat 7AM-7PM', '2017-09-01', 'Full-time', 18000.00, 'h-0001-0000-0000-000000000001'),
('t-005', 'Ravi Kumar',    't-005', '9841300005', 'ravi@hostel.edu',     'Mon-Fri 8AM-5PM', '2021-05-01', 'Full-time', 19000.00, 'h-0001-0000-0000-000000000002'),
('t-006', 'Pandian S',     't-006', '9841300006', 'pandian@hostel.edu',  'Mon-Sat 9AM-6PM', '2022-02-01', 'Full-time', 17000.00, 'h-0001-0000-0000-000000000003'),
('t-007', 'Gopal R',       't-007', '9841300007', 'gopal@hostel.edu',    'On Call',         '2020-11-15', 'Part-time', 12000.00, 'h-0001-0000-0000-000000000001'),
('t-008', 'Sugumar V',     't-008', '9841300008', 'sugumar@hostel.edu',  'Mon-Fri 8AM-4PM', '2023-01-10', 'Full-time', 16000.00, 'h-0001-0000-0000-000000000003');
